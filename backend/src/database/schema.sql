...
CREATE TABLE IF NOT EXISTS configuracion_empresas (
  ...
  pago_transferencia_activo TINYINT(1) NOT NULL DEFAULT 0,
  transferencia_banco VARCHAR(120) NULL,
  transferencia_titular VARCHAR(150) NULL,
  transferencia_cuenta VARCHAR(80) NULL,
  transferencia_clabe VARCHAR(80) NULL,
  transferencia_tarjeta VARCHAR(80) NULL,
  apartado_activo TINYINT(1) NOT NULL DEFAULT 0,
  apartado_porcentaje DECIMAL(5,2) NULL,
  apartado_instrucciones TEXT NULL,
  activo_ia TINYINT(1) NOT NULL DEFAULT 1,
  activo_whatsapp TINYINT(1) NOT NULL DEFAULT 1,
  conversation_engine_explicit TINYINT(1) NOT NULL DEFAULT 0,
  conversation_engine_version ENUM('legacy','ncie','shadow') NOT NULL DEFAULT 'legacy',
  ncie_enabled TINYINT(1) NOT NULL DEFAULT 0,
  ncie_canary_percentage TINYINT UNSIGNED NOT NULL DEFAULT 0,
  ncie_min_confidence DECIMAL(5,4) NOT NULL DEFAULT 0.5500,
  ncie_min_retrieval_score DECIMAL(10,4) NOT NULL DEFAULT 1.0000,
  ncie_auto_rollback_enabled TINYINT(1) NOT NULL DEFAULT 1,
  ncie_max_risk_rate DECIMAL(5,4) NOT NULL DEFAULT 0.3500,
  fecha_creacion TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  fecha_actualizacion TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
